...
- (LFLiveSession *)session {
    if (!_session) {
        ...
        _session = [[LFLiveSession alloc] initWithAudioConfiguration:[LFLiveAudioConfiguration defaultConfigurationForQuality:LFLiveAudioQuality_High] videoConfiguration:videoConfiguration captureType:LFLiveCaptureDefaultMask];
    ...
    if (!_startLiveButton) {
        ...
        [_startLiveButton addBlockForControlEvents:UIControlEventTouchUpInside block:^(id sender) {
            ...
            if (_self.startLiveButton.selected) {
                ...
                stream.url = @"rtmp://3891.livepush.myqcloud.com/live/3891_user_a03dd3dc_b2f7?bizid=3891&txSecret=fff7349dfc2de6d8bb6e58b1890890f1&txTime=5E11E0A1";
